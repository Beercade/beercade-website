...
export const metadata: Metadata = {
  title: "FAQ",
  description:
    "Where Beercade is, when we're open, what it costs to play, and how to book the back room for a function. Redfern NSW, two minutes from the station.",
};
  ...
  return (
    <>
      <PageHeader
        kicker="Good to know"
        title="FAQ."
        lede="Where we are, when we're open, what it costs to play, and how to book the back room. Regent Street, Redfern; two minutes from the station."
      />
      ...
      <Section tone="raised" hairline aria-labelledby="faq-functions">
        ...
        <p className="mt-6 max-w-prose font-body leading-relaxed text-crema/70">
          Short version: we&rsquo;ve got a back room built for it, the enquiry is
          one email, and groups your size have done this before and left happy.
        </p>
        <div className="mt-8">
